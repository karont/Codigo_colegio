 ...
 */
public class PanelConsultaAlumnos extends JPanel implements GUIPanelesInterfaz {
	...
	public PanelConsultaAlumnos() {
		...
		JLabel lblConsultaAlumnos = new JLabel("Consulta Alumnos");
		...
		btnBuscar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				controladorAplicacion.handleRequest(IDEventos.EVENTO_CONSULTAR_ALUMNO, dniAlumno);
			}
		});
	...
	public void actualizarVentana(IDEventos idEvento, Object datos) {
		...
		if ( IDEventos.EVENTO_CONSULTAR_ALUMNO == idEvento ) {
			...
			if ( datos instanceof TransferAlumno) {
				...
				JOptionPane.showMessageDialog(this, "No se pudo obtener el Alumno", "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
		else if ( IDEventos.ERROR_CONSULTAR_ALUMNO == idEvento ) {
